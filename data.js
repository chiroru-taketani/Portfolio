...
const portfolioData = [
    {
        ...
        content: {
            ...
            achievements: "WISS第33回インタラクティブシステムとソフトウェアに関するワークショップ デモ発表 <br>チームラボ賞、対話発表賞<br><br><img src=\"assets/thumb.png\" style=\"width: 100%; border-radius: 8px; margin: 1.5rem 0; box-shadow: 0 4px 20px rgba(0,0,0,0.08);\">",
