...
const portfolioData = [
...

    {
        ...
        content: {
            ...
            background: [
                "従来の式典映像は受動的な視聴に留まることが多く、参加者の関心を惹きつけきれないという課題がありました。そこで、一生に一度の晴れ舞台において、参加者全員が主体的に楽しめる体験を創出したいと考え、作品を制作しました。"
            ],
            techStack: [
            ...
            architecture: [
                "会場に設置したマイクに入力された音声をリアルタイムに取得し、音量に応じて映像に花火を打ち上げるシステムを開発。"
            ],
            challenges: [
                "**課題**: 大きな動作でのインタラクションができない",
                "**解決策**: 参加者が振袖を着ている状況を想定して拍手などで参加できる音声でのインタラクションを実装しました。",
                "**課題**: リアルタイム処理時の描画負荷",
                "**解決策**: パーティクル処理をコンピュートシェーダー（GLSL）に移行し、GPUで並列処理することで安定したフレームレートを維持し参加者に違和感を与えないようにしました。"
            ],
            achievements: [
                "約100名の新成人が参加する式典で運用し、好評でした。また、機材トラブルなく安定稼働を実現しました。"
            ],
            role: [
                "個人開発（企画、システム設計、実装、現場でのセットアップ・オペレーションまで全工程を担当）"
            ],
            links: [
